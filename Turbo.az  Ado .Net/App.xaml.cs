    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            if (DB.carRepository.GetAll().Count == 0)
            {
                ...
                DB.carRepository.AddData(new Car { CityId = 3, ColorId = 5, ModelId = 2, Engine = "3.0", Km = 0.0, Price = 92.000M, Year = new DateTime(2023, 1, 1), CarImage = "https://cdni.autocarindia.com/Utils/ImageResizer.ashx?n=https://cdni.autocarindia.com/ExtraImages/20140501044626_bmw-i8-first-00122.jpg&w=726&h=482&q=75&c=1", FuelTypeId = 1, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 3, ColorId = 1, ModelId = 3, Engine = "2.0", Km = 0.0, Price = 200.000M, Year = new DateTime(2023, 1, 1), CarImage = "https://technote.az/upload/bmw-i4-edrive35-adli-yeni-elektromobilini-teqdim-edib---qiymeti82.jpg", FuelTypeId = 1, IsNew = false });
                ...
                DB.carRepository.AddData(new Car { CityId = 3, ColorId = 5, ModelId = 5, Engine = "7.0", Km = 0.0, Price = 60.000M, Year = new DateTime(2023, 1, 1), CarImage = "https://assets-eu-01.kc-usercontent.com/3b3d460e-c5ae-0195-6b86-3ac7fb9d52db/d38e0995-bb9d-4d74-92e2-321ad60be776/BMW%20i3%20%289%29.jpg?width=1200&fm=jpg&auto=format", FuelTypeId = 4, IsNew = false });

                //mercedes
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 2, ModelId = 6, Engine = "2.8", Km = 0.0, Price = 567.000M, Year = new DateTime(2020, 1, 1), FuelTypeId = 1, IsNew = true, CarImage = "https://www.topgear.com/sites/default/files/2021/10/Large-39276-S-ClassSaloon.jpg?w=892&h=502" });
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 1, ModelId = 7, Engine = "3.0", Km = 0.0, Price = 148.000M, Year = new DateTime(2017, 1, 1), CarImage = "https://turbo.azstatic.com/uploads/full/2022%2F09%2F01%2F14%2F18%2F17%2F71f08c4f-aabf-4113-bc24-63af7134d5a8%2F56854_ptv6AjDCrrVXjMNJg1jejw.jpg", FuelTypeId = 1, IsNew = true });
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 5, ModelId = 8, Engine = "2.0", Km = 0.0, Price = 38.000M, Year = new DateTime(2019, 1, 1), CarImage = "https://www.motortrend.com/uploads/f/52840685.jpg?fit=around%7C874:546.25", FuelTypeId = 1, IsNew = false });
                ...
                //lada
                DB.carRepository.AddData(new Car { CityId = 3, ColorId = 5, ModelId = 10, Engine = "3.0", Km = 0.0, Price = 200.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://cdnstatic.rg.ru/crop910x607/uploads/images/193/89/13/XRAY_Instinct_2.jpg", FuelTypeId = 1, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 1, ModelId = 11, Engine = "4.0", Km = 0.0, Price = 199.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://motor.ru/thumb/908x0/filters:quality(75):no_upscale()/imgs/2022/12/19/08/5719745/8810b116809165a0c2595daa9075ddcb1d848338.jpg", FuelTypeId = 2, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 2, ColorId = 6, ModelId = 12, Engine = "3.0", Km = 0.0, Price = 399.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://turbo.azstatic.com/uploads/full/2020%2F06%2F19%2F11%2F46%2F33%2F5a55a264-11d1-46a1-9349-f9fc12f0717b%2F2412_BlzuYkBR_w1iEpFwrqLbMA.jpg", FuelTypeId = 1, IsNew = false });

                //ferrari
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 5, ModelId = 13, Engine = "4.0", Km = 0.0, Price = 209.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://squir.com/media/catalog/product/cache/4709fd52db70e8ed3553f7ffe9d447ff/f/e/ferrari_purosangue_2023_0000.jpg", FuelTypeId = 1, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 2, ColorId = 6, ModelId = 14, Engine = "3.0", Km = 0.0, Price = 500.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://m.atcdn.co.uk/vms/media/3be3196042ec47b69a12ff7ceb29c22e.jpg", FuelTypeId = 1, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 4, ColorId = 3, ModelId = 15, Engine = "5.0", Km = 0.0, Price = 700.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://www.driving.co.uk/wp-content/uploads/sites/5/2014/04/458.jpg", FuelTypeId = 1, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 4, ColorId = 5, ModelId = 16, Engine = "2.6", Km = 0.0, Price = 900.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://www.motortrend.com/uploads/2023/04/2023-Ferrari-Roma-exterior-8.jpg?fit=around%7C875:492.1875", FuelTypeId = 1, IsNew = false });
                ...
                //Rolls Royce
                DB.carRepository.AddData(new Car { CityId = 4, ColorId = 6, ModelId = 18, Engine = "6.0", Km = 0.0, Price = 1800.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://www.cnet.com/a/img/resize/cbd1491e95314f4e6e4429a0a6b10715971ccd4d/hub/2020/08/13/c8fe14c5-182a-4a3d-94b8-d404b935dbc3/rolls-royce-wraith-2020-09236.jpg?auto=webp&width=1200", FuelTypeId = 1, IsNew = false });
                ...
                //Tesla
                DB.carRepository.AddData(new Car { CityId = 2, ColorId = 7, ModelId = 32, Engine = "0.0", Km = 0.0, Price = 700.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://i.ebayimg.com/images/g/oFcAAOSwMsxkkkXm/s-l1600.jpg", FuelTypeId = 4, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 1, ModelId = 33, Engine = "0.0", Km = 0.0, Price = 800.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://i.ebayimg.com/images/g/mRMAAOSwdY5kkhjY/s-l500.jpg", FuelTypeId = 4, IsNew = false });
                DB.carRepository.AddData(new Car { CityId = 2, ColorId = 7, ModelId = 34, Engine = "0.0", Km = 0.0, Price = 400.500M, Year = new DateTime(2021, 1, 1), CarImage = "https://i.ebayimg.com/images/g/CvAAAOSwSHpkBH-E/s-l1600.jpg", FuelTypeId = 4, IsNew = false });

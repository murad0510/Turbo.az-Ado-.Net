...
namespace Turbo.az__Ado.Net
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            {
                //mercedes
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 1, ModelId = 6, Engine = "2.8", Km = 0.0, Price = 567.000M, Year = new DateTime(2020, 1, 1), FuelTypeId = 1, IsNew = true });
                ...
                DB.carRepository.AddData(new Car { CityId = 3, ColorId = 2, ModelId = 3, Engine = "2.0", Km = 0.0, Price = 200.000M, Year = new DateTime(2023, 1, 1), CarImage = "https://cdn.motor1.com/images/mgl/8APgLe/s3/2023-bmw-i7.webp", FuelTypeId = 1, IsNew = false });
                ...
                DB.carRepository.AddData(new Car { CityId = 2, ColorId = 5, ModelId = 12, Engine = "3.0", Km = 0.0, Price = 399.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://kolesa-uploads.ru/-/933e696b-61a7-4ceb-a276-e3984f77f1d5/lada-priora-sport-front2-mini.jpg.webp", FuelTypeId = 4, IsNew = false });

                //ferrari
                DB.carRepository.AddData(new Car { CityId = 1, ColorId = 5, ModelId = 13, Engine = "4.0", Km = 0.0, Price = 209.500M, Year = new DateTime(2023, 1, 1), CarImage = "https://all-car-news.com/wp-content/uploads/2022/09/ferrari-purosangue-2022-zijkant.jpg?ezimgfmt=rs%3Adevice%2Frscb2-1", FuelTypeId = 4, IsNew = false });
